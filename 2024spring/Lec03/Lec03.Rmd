...
- 长期决策依然延续“生产技术→成本的”思考方式，但是
  - 长期的不同是企业可以调整所有生产要素（劳动和资本）→ 允许企业选择最优的要素组合来最大化产量或效率 → 长期生产函数应该反映要素间的技术替代关系
...
- “长期关系说”（Oliver Williamson,1932-2020） 发展了交易成本理论。企业交易时会面临着特定投资（specific investment）和高转换成本（switching cost）
