...
- .hi-green[我的邻居喜欢高大的树] 
  ...
  - 她是否有权在她遮挡我泳池的房产上种树？ 
  - 我是否有权享有无遮挡的视野？或无遮挡的泳池？ 
  
- .hi-green[你想举办派对] 
  - 你是否有权在你家/宿舍制造噪音？ 
  - 你的邻居是否有权在他们家/宿舍里安然入睡？ 
...
- 科斯：如果你理解亚当·斯密，这里没有什么新东西或激进的东西 

- 资源往往流向那些最重视它们的人 

- .hi-green[示例]：如果你现在拥有这辆车，我将付钱让你买下它
]
...
- 我们不需要诉诸法律来进行双方同意的交易（比如汽车） 

- 更有趣的是我们自己的财产的.hi[不兼容用途]，它导致了冲突 

- A的财产使用给B带来了.hi-purple[外部性] 

- 在这里，我们确实需要法律来界定权利...但这并不是故事的结束
]
...
- 施害方 $\xrightarrow{harms}$ 受害方

- .hi-green[例子]: 
  - 老旧工厂污染 $\xrightarrow{harms}$ 附近住户
  - 邻居种树遮蔽 $\xrightarrow{harms}$ 游泳池
  - 邻居聚会吵闹 $\xrightarrow{harms}$ 安静的邻居

- 税收/限制是施害方 (A) 直到 MPC = MSC
]
...
- 伤害实际上是.hi-turquoise[双边]的，而不是单边的
  -  A $\underbrace{\iff}_{harms}$  B
...
.source[Coase, Ronald H, 1960, "社会成本问题," *Journal of Law and Economics* 3:1-44]
...
> “传统的方法往往使我们必须做出的选择变得不清晰。人们通常认为问题在于 A 伤害了 B，因此我们需要决定如何限制 A 的行为。

>但这种看法是错误的。我们面对的实际上是一个相互作用的问题，即在防止伤害 B 的同时，可能会不可避免地伤害到 A

>因此，我们真正需要决定的是：是应该容忍 A 伤害 B，还是应该容忍 B 伤害 A？” (p.2).
...
- 糖果制造商正在伤害医生和受害者，并未内部化其机器的外部成本

- Harm: $A \rightarrow B$  

- 对施害方 (A)纳税 直到他的 MPC = MSC]
...
- 社会愿意以什么样的比例牺牲糖果来换取更多的医疗服务，或者反过来，又会怎样呢？

]

.pull-right[
.center[
![ 100%](https://www.dropbox.com/s/wflae00wz65gbun/court1.jpg?raw=1)
]
]
...
- 同样，.hi-purple[效率并不重要]产权授予谁并不重要，只要各方可以.hi[讨价还价] 

- .hi-turquoise[如果医生胜诉]：糖果商可以付钱给医生制造噪音，或购买隔音设备 

- .hi-turquoise[如果糖果商胜诉]：医生可以付钱给糖果商减缓/安静生产，或购买隔音设备
]

.pull-right[
.center[
![ 100%](../images/sturges.png)
...
- 科斯：忘记“**黑板经济学**”，去研究现实世界的制度

- 开设“法学与经济学”专业


> 如何分配产权以最大程度地减少外部性的总成本并最大程度地提高效率？
...
.pull-left[
.smallest[
- 即使在法律中，也有“金钱”与实际外部性的区别 

- .hi-green[示例]：我纵火烧毁了你的房子。 

- .hi-purple[实际损害 physical damage]：这指的是直接的、具体的损失
  - 房屋被纵火烧毁所造成的直接损失。这种损害通常较易于量化，因为它关注的是具体的财产或资源的损失
  - 实际外部性 

- .hi-purple[纯粹的经济损失 pure economic loss]：涉及到因某一事件或行为导致的更广泛的市场或社会经济影响
  - 一处房产被烧毁可能会影响周围房屋的市场价值，可能是因为增加了该地区的不安全感，或者改变了邻里环境的吸引力。这种损害更难量化，因为它涉及到广泛的市场心理和经济因素
  - 金钱外部性
]
]
...
.smallest[
> “法官必须决定法律责任，但这不应该让经济学家对所涉及的经济问题的性质感到困惑。在牛和庄稼的案例中，如果没有牛，就不会有庄稼受损，这是真的。同样真实的是，如果没有庄稼，就不会有庄稼受损。如果糖果商没有操作他的机器，医生的工作就不会受到干扰；但如果医生没有在那特定的地方设立他的咨询室，机器就不会打扰任何人...” (p.13).
...
.smaller[
> “如果我们从因果关系的角度讨论这个问题，双方都会造成损害。如果我们要实现资源的最佳配置，因此，当决定行动方针时，双方都应考虑有害影响。平稳运行的定价系统的一个优点是……由于有害影响造成的产值下降对双方来说都是一种成本，” (p.13).
...
> 如果交易成本低，产权界定明确且可交易，各方可自愿讨价还价以达成有效结果
...
- 初始时对财产权的分配看似无关紧要，因为无论如何分配，我们最终都能达到一个高效的结果

- 然而，这种初始的分配确实对最终的资源分布有着重要影响
]
]
...
- .hi[科斯定理有效的前提：]关于交易成本较低时的情况

- 这也暗示了推论：.hi-purple[当交易成本很高时，自愿谈判不会达到有效结果！]

]

.pull-right[
.center[
![](./figs/transactionscosts.JPG)
]
]
...
<img src=./figs/Nobel.png height=22> Economics Nobel 1991
]
...
.smaller[
> 如果市场**交易没有任何成本**，那么（不考虑公平性问题）只需确保各方的**权利明确**无误，且**执法结果**能够预测即可

> 然而，当市场交易的成本很高，足以使法律所确立的权利安排难以更改时，情形则截然不同

> 在这种情况下，法院对经济活动有直接的影响

> 即便可以通过市场交易来调整法律的权利划分，显然减少这类交易的需求，并因此降低实施这些交易所需的资源，是更为理想的做法
...
> 然而，我更愿意把**科斯定理**看作是分析**存在正交易成本经济体系**的起点。

> **科斯定理**的重要性在于，它挑战了传统的**庇古体系**

> 传统经济理论通常假设交易成本为零，从这个前提出发，科斯定理表明在这些情况下无需采用庇古的解决方案。当然，这并不表示在交易成本为正的情况下，依赖市场个体间的谈判不如政府干预（如政府运维government operation,监管regulation、征税taxation及补贴subsidies）来得更有效。我们应该观察实际政府的行为，而非空想中的政府来验证这一点。我的结论是：**我们应当深入研究存在正交易成本的世界**

]

.source[Coase, Ronald H, 1992, “生产的制度结构” *American Economic Review* 82(4): 713-719]
...
> 市场上的交易对象并不仅是**物理实体**，正如经济学家们常见的误解，而实际上是进行某些行为的权利，这些权利是由**法律体系**所定义的

> 由于[存在交易成本]，个体的权利rights、义务duties和特权privileges在很大程度上受法律的决定。因此，**法律体系对经济系统的运行具有深刻影响**，某种意义上甚至可以说它对经济系统具有控制作用。显然，**最理想的情况是将这些权利分配给那些能够最高效利用它们的人，并提供激励以促使他们这样做**。此外，为了找到（并保持）这种权利分配，转移这些权利的成本应当保持低廉”
...
- 外部性可以被构建为.hi-purple[产权]的问题 

- 交易实际上是关于商品和服务的所有权（不仅仅是商品本身） 
...
.right-column[
- .hi["科斯定理"]: 如果交易成本低，无论谁拥有产权，各方都会讨价还价以达成有效的结果 

- 科斯: 交易成本很高，因此产权如何分配很重要! 
...
- .hi[公地悲剧]：多人对同一 .hi-purple[竞争性]资源拥有不受限制的访问权限 

- .hi-purple[竞争]：对资源的一种使用会将其从其他用途移除


.source[Hardin, Garett, 1968, "公地悲剧," *Science* 162(3859):1243-1248]
...
.pull-left[
.center[
![ 100%](https://www.dropbox.com/s/qgnqwqr86wi1nlz/pollutedriver.png?raw=1)
]
]
...
- .hi[产权]：社会公认的规则，决定了如何使用资源 

- 首要权利是.hi-purple[排除他人]使用竞争性资源的权利
]
...
> “在人类的想象和情感中，没有什么能像财产权这样具有普遍影响力；这种权利体现为一个人对世界上的外部事物拥有绝对且独裁的控制权，彻底排除了宇宙中任何其他个体的权利。（第二册，第一章）


.source[布莱克斯通爵士 1765-1769, *《英格兰法律注释》*]
...
- 想象两个相邻的农民 
- 博弈论互动 
- 每个农民都可以 .hi-purple[耕种] 或 .hi-purple[偷窃]
]
...
- .hi-purple[纳什均衡]: (.red[偷窃], .blue[偷窃]) 

- .hi-purple[社会最优均衡]: (.red[耕种], .blue[耕种])
...
.left-column[
.center[
![ 80%](https://pkuzzq-image.oss-cn-beijing.aliyuncs.com/uPic/g8MnDf.png)
...
> “然而，虽然人们可以在没有政府的情况下维持一个规模较小、较为原始的社会，但在缺乏正义的情况下，他们却无法维持任何形式的社会

>这里所说的‘正义’，指的是遵守关于所有权的稳定性、财产的自愿转让以及履行承诺的三个基本原则”

.source[Hume, David, 1751, *道德原理研究*]
...
.pull-left[
.smallest[
- 假设有很多农民面临着同样的问题——他们认识到建立财产规则和惩罚盗窃行为可以实现社会最优
- 建立一个产权法律体系（以及某人来执行它）的成本为 $c$
- 盗窃的处罚是 $P$
- 如果 $10-c>12-P$，则（.red[农场]，.blue[农场]）成为均衡
...
> “.hi[Property rights develop to internalize externalities when the gains from internalization become larger than the costs of externalization],” (p.350).
...
- .hi[If transaction costs are high, *inefficient* to create property rights!]
]
]
...
# Tech. Change Can *Reduce Costs* of Property Rights

.center[
![ 60%](https://www.dropbox.com/s/dw0vevynralcmxm/barbedwirestory.png?raw=1)
]
...
.center[
![ 100%](../images/spectrumauctionsarticle.png)
]
...
- .hi[“Liability rule”]: .hi-purple[damages] awarded for broken promises and accidents
...
- .hi-green[Example]: With Rancher's cattle straying onto Farmer's crops
...
.pull-right[
.center[
![ 70%](../images/wheat2.jpg)

![ 70%](../images/grazing_cattle.jpg)
]
]
...
.source[Calabresi, Guido and A. Douglas Melamed, 1972, “Property Rules, Liability Rules, and Inalienability: One View of the Cathedral,” *Harvard Law Review* 85(6): 1089—1128]
...
- As per Coase (1960), .hi-purple[any rule leads to efficiency under .ul[no transaction costs]]
...
- When .hi-purple[transaction costs are low] and .hi-purple[information costs are high], structure the law so as to .hi-purple[minimize transaction costs]
  - .hi[Property rule] (injunction) more efficient: clarify right and allow trade

- When .hi-purple[transaction costs are high] and .hi-purple[information costs are low], structure the law so as to .hi-purple[allocate property rights to whomever values them the most]
  - .hi[Liability rule] (damages) more efficient: give injurer right to violate entitlement when efficient, even without prior consent
...
.pull-right[
![ 100%](https://www.dropbox.com/s/28zepcoaev096te/steenberg.jpg?raw=1)
]
.center[
