...
- 背后原因：场馆的公共物品属性，更新改造成本高额；频率增加，随着广播电视的发展，联盟扩张迅速，寻求好的转播环境。大都会区的城市平均每年启动6个大型体育场馆项目
...
- **球队的公共物品性质**：
  - 球队获利后可能提升城市品牌、增强社会凝聚力、提高居民满意度等，从而具有公共物品的属性。
...
.small[
- .hi[社会计价：按照**产品计酬原则**]
  - 消费侧在市场定位成本：你消费的东西，你要补偿它的社会边际成本（社会机会，其他人使用机会）
  - 供给侧在市场定位收益：社会应该补偿你所创造的边际收益

- 价格体系（当市场运行良好时）在利润率上适当调整激励措施
...
- 外部性：.hi[边际私人成本/收益 与 社会成本/收益之间的差异]

- 人们应该为自己的行为支付平均外部性 
  - 市场会让你自动这样做 
  - 如果市场失败，政策可以迫使市场重新运作

- .hi-purple[外部性的问题在于缺少价格！]
]
...
- 这些权利是 .hi[非人格化的] —— 它们附属于财产，而不是人


- 业主 .hi[有自由] 行使其财产权的权利（法律既不禁止也不强制他这样做）


- 其他人 .hi[被禁止干涉] 业主行使其权利
...
ggplot() + 
  ...
  annotate("text", label = wrapper(expression("公共池塘资源"), 10), x = 2.5, y = 2.5, family =cnfont, size = 6, color = red_pink) +
  annotate("text", label = expression("(纯粹)公共物品"), x = 7.7, y = 2.5, family =cnfont, size = 6, color = red_pink) +
  # theme stuff
  theme_goods +
...
ggplot() + 
  ...
  annotate("text", label = expression("俱乐部物品"), x = 7.5, y = 7.5, family =cnfont, size = 6, color = purple) +
  annotate("text", label = wrapper(expression("公共池塘资源"), 10), x = 2.5, y = 2.5, family =cnfont, size = 6, color = red_pink) +
  annotate("label", label = expression("(纯粹)公共物品"), x = 7.7, y = 2.5, family =cnfont, size = 6, color = red_pink) +
  # theme stuff
  theme_goods +
  geom_segment(aes(x = 5, y = 0, xend = 5, yend = 10), linetype  = "solid", size = 1) +
  geom_segment(aes(x = 0, y = 5, xend = 10, yend = 5), linetype  = "solid", size = 1) +
...
- 政府干预可能会增加社会福利，但如果政府想要最大化社会福利，那应该提供多少公共物品呢？有其他方法么？
]
...
.center[
<img src=https://pkuzzq-image.oss-cn-beijing.aliyuncs.com/uPic/4YMiH6.png height=165>]
- (纯粹)公共物品因为具有非排他性，本质上属于.bb[消费或生产具有正外部性]的产品
- (回忆)正外部性存在时，.bb[**市场均衡供给必然低于社会最适供给**]
- 消费者普遍具有**搭便车**想法
  - 在不具有排他性下，消费者为了自身利益，会**隐藏**对公共物品的偏好，而生产者缺乏准确的消费者偏好信息下，自然无法收取适当费用
  - 当大部分消费者都这样想，**厂商供给低于最适水平**
- 即便是具有一定程度排他性的公共物品，在给定供给量下，非敌对性使得多一个消费者使用的边际成本为0或支付极低价格 → 生产者的收入也不足以支撑供给需要的成本
...
.small[
> “国家或公共权力的一个重要职责是.hi[创建和维持那些公共机构和工程]。虽然这些设施对大社会极为有益，但.hi[其性质决定了个人或少数人的利润无法抵偿投入的成本]，因此.hi[不应期待个人或少数人来建立或维护这些设施]。此外，根据社会发展的不同阶段，执行这一职责所需的开支也大不相同。” (Book VI, Ch. 9).
...
- 通常公共物品不足： 公共物品是对整个社会都有好处的资源，比如公共道路、清洁空气等。然而，由于个人在使用这些资源时不需要付费，可能会导致过多的使用，最终资源不足

- 政府供给公共物品： 为了解决这个问题，政府可以介入，通过使用税收的方式，直接提供公共物品。这意味着政府会用收集来的税收来建设和维护公共池塘资源，以确保人们可以享受到这些资源的好处

- 政府代替市场： 当政府提供公共物品时，会取代市场在分配资源上的作用。市场通常通过供需关系来决定资源的分配，而政府提供公共物品则是基于社会的整体需求和利益

- 经济效率问题： 问题的关键在于，政府是否能够在提供公共物品时达到经济效率。尽管政府的目标是为社会提供福利，但政府也可能面临资源利用不当、效率低下等问题

- 理论上的可能： 理论上，政府是有可能提供公共物品的，以弥补市场无法满足的需求。然而，这需要政府有效地收集税收、进行资源分配，以及避免浪费。在实际中，政府的角色和能力会因国家和政策而异
...
- 集体行动问题：个人的利益与整个团体的利益可能存在冲突的情况

- 对于结果，团体中**每个**成员都会受益而且承担成本

- 共享结果依赖于个体决策

- **个人偏好**需要**整合**成一个统一决策或偏好
]
...
- 此外，**交易成本**或者**讨价还价**的机制能够让群体决策达成一致
]
...
.small[
> 至少在涉及经济目标时，人们通常认为，具有共同利益的个人群体通常会尝试促进这些共同利益。具有共同利益的个人群体有望代表其共同利益采取行动，就像个人通常有望代表其个人利益采取行动一样……认为群体采取行动来服务其利益的观点大概基于这样的假设：群体中的个人出于自私自利而采取行动……但事实上，群体将根据其自身利益采取行动的想法并不合乎逻辑地遵循理性且自私自利的行为前提。它不会遵循，因为…… .hi[*理性的自私自利者不会采取行动来实现他们的共同或群体利益*]， (pp.1-2).
...
- 在异质群体中，.hi[“大对小的剥削”]: 较大的/较富有的成员比较小的/较贫穷的成员贡献更多

>一旦较小的成员从较大的成员那里获得了集体利益，他拥有的就比他自己购买的要多，并且没有动力自掏腰包来获得任何集体利益”（p. 35).
...
- 团体通常需要 .hi[“选择性激励”] 来奖励贡献并惩罚**搭便车**行为

  - 向缴纳会费的成员提供二级私人商品（保险计划、获取行业出版物、折扣、津贴等） 
...
- 团体通常会采取以下措施的某种组合来克服搭便车的问题： 
  - 牺牲：成员投资于昂贵且显眼的行为：穿着特定服装、参加会议、学习仪式、缴纳会费、食用特定饮食等 
  - 耻辱：不做出贡献或做出牺牲的成员会受到羞辱和排斥（或被踢出）
...
- .hi[代表性产品]：大部分的订阅或会员制服务都是俱乐部物品(Netflix、健身房、高尔夫俱乐部等) 
]
...
ggplot() + 
  ...
  annotate("text", label = expression("私有物品"), x = 2.5, y = 7.5, family =cnfont, size = 6, color = purple) +
  annotate("text", label = expression("俱乐部物品"), x = 7.5, y = 7.5, family =cnfont, size = 6, color = purple) +
  annotate("label", label = wrapper(expression("公共池塘资源"), 10), x = 2.5, y = 2.5, family =cnfont, size = 6, color = red_pink) +
  annotate("text", label = expression("(纯粹)公共物品"), x = 7.7, y = 2.5, family =cnfont, size = 6, color = red_pink) +
  # theme stuff
  theme_goods +
  geom_segment(aes(x = 5, y = 0, xend = 5, yend = 10), linetype  = "solid", size = 1) +
...
- 公共池塘资源：政府供给 .mono[+] 联合供给 .mono[+] 自愿供给
]
