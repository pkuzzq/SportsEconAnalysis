...
- 胜利或者胜率（wins or winning percentage)： 如果球队收入和受欢迎程度正相关，那么产出TP以胜利w或胜率wp就是合理的，而不是参赛数量 .mono[->] 连接了要素和收入

- 这里潜在的假设是：**利润来自胜率(profit from win percentage)**
...
寻租问题只是垄断的后果之一，是站在社会公平和正义角度

经济学家最初的出发点是基于效率。

垄断造成的**无谓损失**就是效率损失的表现之一。

此外，当讨论市场机制下的效率损失时，通常被归结为**市场失灵**的结果
