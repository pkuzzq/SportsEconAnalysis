...
# Notes directory
dir_slides <- "/Users/zhouzhengqing/Desktop/SportsEconAnalysis/SportsEconAnalysis_2023/Lec01/"
# Define pink color
red_pink <- "#e64173"
turquoise <- "#20B2AA"
orange <- "#FFA500"
...
1. 经济学的十大原理 .mono[->] 初步建立经济学思维

2. 经济学的主要框架 .mono[->] 完成属于自己的**知识路径成长图**

2. 研究的类型 .mono[->] 聚焦经验研究，识别**因果关系**
...
- **宏观经济学**。将经济视为一个整体，它侧重于广泛的问题，例如生产增长、失业人数、物价、政府赤字以及进出口 .mono[->] 货币政策和财政政策
- 微观经济学和宏观经济学不是独立的学科，而是对整个经济学科的互补观点。

经济学家习惯用使用**理论**或**模型**来刻画世界
- **理论**是对两个或多个变量间如何相互作用的简化表述 .mono[->] 将复杂、现实世界问题简化为它的本质
...
上图是循环流图，将经济描述为家庭和企业两个主体的运转，箭头表示流向。A .mono[+] B是产品市场，C .mono[+] D是劳动力市场。
...
.center[
<img src=https://pkuzzq-image.oss-cn-beijing.aliyuncs.com/uPic/wny1KH.png height="520">
]
...
提出观点：人们会对激励做出反应 .mono[->] 
提出假设：资源稀缺 + 理性人（效用最大化和利润最大化）.mono[->] 
理论建模 
