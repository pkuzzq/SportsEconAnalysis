...
哎？刚才不是已经说到了显成本和隐成本么？这里为什么深入分析呢？
...
为什么要考虑 平均成本？
社会平均总成本的降低就意味着企业的规模是有效的， 在图表上反映，就是平均成本平均成本曲线的最低点，就是企业达到有效规模的是 
...
???
.tiny[
回一下边际产量和平均产量的关系 , 当边际成本低于平均总成本的时候，那么追加产出就意味着组成的会平均成本就会下降，那么这时候企业就会往更加有效的规模去发展 .  边际成本那么之后就会上升上升到高过平均总成本的时候，那么企业再追加铲除那个这时候企业的平均成本就会上升了 
]
...
那么长期根据企业的盈利能力, 那么可以扩大规模，也可以压缩企业规模。
...
在经济实体规模扩大时，产量的增加小于要素投入的增加比例，收益递减,那么就应该控制规模。
