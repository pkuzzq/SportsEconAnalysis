...
# Notes directory
dir_slides <- "~/Users/zhouzhengqing/Desktop/SportsEconAnalysis-master/CausalityPlus_01_Matching"
# Define pink color
red_pink <- "#e64173"
turquoise <- "#20B2AA"
orange <- "#FFA500"
...
theme_minimal(base_size = 20, base_family = cnfont) +
scale_x_continuous("ps(X)", limits = c(0, 1)) +
ylab("Density") +
theme(
  axis.title = element_text(family = cnfont, size = 22, face = "italic"),
...
# Plot
ggplot(
  data = no_overlap %>% dplyr::filter(between(p, 0.15, 0.85)),
  aes(
    x = p,
    fill = factor(trt, labels = c("C", "T"))
  )
...
scale_fill_manual("", values = c(purple, red_pink)) +
theme_minimal(base_size = 20, base_family = cnfont) +
scale_x_continuous("估计的ps(X)", limits = c(0.15, 0.85)) +
ylab("Density") +
theme(
  axis.title = element_text(family = cnfont, size = 22, face = "italic"),
  panel.grid.major = element_line(size = 0.5, color = "grey95"),
...
scale_fill_manual("", values = c(purple, red_pink)) +
theme_minimal(base_size = 20, base_family = cnfont) +
scale_x_continuous("估计的ps(X)", limits = c(0, 1)) +
ylab("Density") +
theme(
  axis.title = element_text(family = cnfont, size = 22, face = "italic"),
  panel.grid.major = element_line(size = 0.5, color = "grey95"),
...
pagedown::chrome_print("CausalityPlus_01_Matching.html", output = "CausalityPlus_01_Matching.pdf")
```