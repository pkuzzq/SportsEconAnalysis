...
.hi.pink[答案： ] **不是** .mono[-->] 发垄断法是制约实体单位的，该结果意味联盟整体行为是各个球队联合决策的结果，有不受反垄断法制约的理由

2) NFL中单个球队与锐步协议是否受《谢尔曼反垄断法》约束?

.hi.pink[答案： ] **是** .mono[-->] 当球队拥有并控制着各自标志和商标使用时，即便与NFL有利益冲突，单支球队是可以与其他球队存在商业竞争关系。球队若与联盟达成协议，**共谋**将视为违反《谢尔曼反垄断法》。**相当于承认了球队和联盟在各自市场中的独占地位**。实际中，联盟在转播收入和许可收入以单一实体形式签署合同
...
---
### 讨论：减税能够减少无谓损失么?
减税的目的是期望增加独占厂商的利润，减少其掠夺消费者剩余的企图心
.center[
...
1. "财政公平法案"是什么?措施有哪些？是否有效促进了公平？是否有效改善小市场球队的财务困难？各国联赛还推出了那些收入分享制度？
